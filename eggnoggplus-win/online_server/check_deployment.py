...
def main() -> int:
    ...
    require_exact_int(info, "cap_client_build_gate", 1)
    ...
    print(
        ...
        "packet authentication, social controls, private rematches, client build gating, UDP relay, and UDP discovery available"
    )
    return 0
